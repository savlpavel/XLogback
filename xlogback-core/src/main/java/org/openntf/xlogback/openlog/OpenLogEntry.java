 ...
 * http://www.openntf.org/main.nsf/project.xsp?r=project/XPages%20OpenLog%20Logger - Authors: Paul S. Withers, Nathan T. Freeman, Tim
 * Tripcony - OpenLog Project, licensed under the Apache License - http://www.openntf.org/main.nsf/project.xsp?r=project/OpenLog -
        ...
        try {
            ...
            if (null != ee) {
                ...
                if (ee instanceof NotesException) {
                    ...
                    if (StrUtils.isEmpty(getMessage())) {
